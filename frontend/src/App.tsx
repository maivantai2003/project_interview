...
function App() {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col text-slate-800">
      <header className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-indigo-600 to-blue-600
      ...
      <main className="flex-1 overflow-hidden mt-[80px]">
        <div className="max-w-7xl mx-auto h-full p-6">
          <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-6 h-full min-h-0">
            <Routes>
